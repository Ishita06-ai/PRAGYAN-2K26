...
{/* Gaming Corner Decorative Elements */}
      <div className="fixed inset-0 z-10 pointer-events-none">
        ...
        <div className="absolute top-0 left-0 w-32 h-32 md:w-40 md:h-40">
          {/* Outer glow layer */}
          <div className="absolute top-0 left-0 w-full h-2 bg-gradient-to-r from-red-500 via-purple-500 to-transparent blur-sm opacity-75"></div>
          ...
          {/* Main border */}
          <div className="absolute top-0 left-0 w-full h-1.5 bg-gradient-to-r from-red-600 via-purple-600 via-cyan-500 to-transparent"></div>
          <div className="absolute top-0 left-0 w-1.5 h-full bg-gradient-to-b from-red-600 via-purple-600 via-cyan-500 to-transparent"></div>
        ...
        <div className="absolute top-0 right-0 w-32 h-32 md:w-40 md:h-40">
          {/* Outer glow layer */}
          <div className="absolute top-0 right-0 w-full h-2 bg-gradient-to-l from-red-500 via-purple-500 to-transparent blur-sm opacity-75"></div>
          ...
          {/* Main border */}
          <div className="absolute top-0 right-0 w-full h-1.5 bg-gradient-to-l from-red-600 via-purple-600 via-cyan-500 to-transparent"></div>
          <div className="absolute top-0 right-0 w-1.5 h-full bg-gradient-to-b from-red-600 via-purple-600 via-cyan-500 to-transparent"></div>
        ...
        <div className="absolute bottom-0 left-0 w-32 h-32 md:w-40 md:h-40">
          {/* Outer glow layer */}
          <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-red-500 via-purple-500 to-transparent blur-sm opacity-75"></div>
          ...
          {/* Main border */}
          <div className="absolute bottom-0 left-0 w-full h-1.5 bg-gradient-to-r from-red-600 via-purple-600 via-cyan-500 to-transparent"></div>
          <div className="absolute bottom-0 left-0 w-1.5 h-full bg-gradient-to-t from-red-600 via-purple-600 via-cyan-500 to-transparent"></div>
        ...
        <div className="absolute bottom-0 right-0 w-32 h-32 md:w-40 md:h-40">
          {/* Outer glow layer */}
          <div className="absolute bottom-0 right-0 w-full h-2 bg-gradient-to-l from-red-500 via-purple-500 to-transparent blur-sm opacity-75"></div>
          ...
          {/* Main border */}
          <div className="absolute bottom-0 right-0 w-full h-1.5 bg-gradient-to-l from-red-600 via-purple-600 via-cyan-500 to-transparent"></div>
          <div className="absolute bottom-0 right-0 w-1.5 h-full bg-gradient-to-t from-red-600 via-purple-600 via-cyan-500 to-transparent"></div>
