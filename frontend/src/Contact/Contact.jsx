      ...
      <main className="flex-grow relative overflow-hidden z-10">
        ...
        <section className="pt-10 pb-8 px-4 text-center">
          <div className="max-w-7xl mx-auto">
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-black tracking-[12px] bg-gradient-to-b from-white via-cyan-200 to-gray-600 bg-clip-text text-transparent uppercase">
              PRAGYAA
            </h1>
            <p className="text-sm sm:text-lg tracking-[3px] uppercase text-gray-300 font-light mt-2">
        ...
        <section className="py-6 px-4 text-center">
          <div className="max-w-7xl mx-auto">
            <h2 className="text-5xl md:text-6xl lg:text-7xl font-black tracking-wider bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent uppercase mb-6">
              Contact Us
            </h2>
            <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Get in touch with us for any inquiries about PRAGYAA 2026
            </p>
            <div className="w-32 h-1 bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 mx-auto rounded-full" />
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              {contactInfo.map((info) => (
                <div
                  key={info.id}
                  className="bg-gray-900/95 backdrop-blur-xl border border-cyan-500/20 rounded-2xl p-6 text-center"
                >
                  <div className="mb-4 flex justify-center">{info.icon}</div>

                  <h3 className="text-xl font-bold text-white mb-3 tracking-widest">
                    {info.title}
                  </h3>
                  ...
                  {info.link && (
                    <a
                      href={info.link}
                      className="inline-block px-4 py-2 bg-cyan-500 rounded-lg font-semibold text-white transition-colors duration-300 hover:bg-cyan-600"
                    >
